...
module.exports = function(
  ...
  const ownPackage = require(path.join(
  ...
  args.push('react', 'react-dom', 'electron');
  ...
  if (!areDependenciesInstalled(appPackage) || template) {
...
function areDependenciesInstalled(appPackage) {
